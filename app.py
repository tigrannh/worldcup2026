...
if page == "ԿԱՆՈՆՆԵՐ":
    ...
    <div class="glass-card">
      ...
      <ul style="color:#FFFFFF; font-size:1.05rem;">
        <li><b>📦 Խմբի աղյուսակ՝</b> ճիշտ <b>հաղթող +6</b>, ճիշտ <b>2-րդ տեղ +4</b> (յուրաքանչյուր խմբի համար)։
            <br><b style="color:#FFD700;">ℹ️ Ուշադրություն՝</b> խմբի աղյուսակը կազմվում է <b>քո կանխատեսած հաշիվներով</b>։ Եթե խմբի որևէ խաղ բաց ես թողել՝ այն հաշվվում է որպես <b>0-0</b>, և բոնուսը հաշվարկվում է այդ աղյուսակով։ Այսինքն՝ բոնուս ստանում ես նույնիսկ եթե բոլոր 6 խաղերը չես կանխատեսել (բայց որքան շատ ճիշտ կանխատեսես՝ այնքան ճշգրիտ կլինի աղյուսակդ)։</li>
        <li><b>✅ Որակավորում՝ +1</b> միավոր յուրաքանչյուր թիմի համար, որը ճիշտ ես կանխատեսել, որ կանցնի 1/16 փուլ (առավելագույնը +32)։ Այստեղ ևս բաց թողած խաղերը հաշվվում են որպես <b>0-0</b>։</li>
    ...
    <div class="glass-card">
      ...
      <ol style="color:#FFFFFF; font-size:1.05rem;">
        ...
        <li>Եթե <b>միավորները հավասար են</b> → առաջինը նայում ենք <b>իրար միջև խաղերը</b> (միայն այդ հավասար թիմերի միմյանց դեմ խաղերը)․ նրանց միջև՝ ա) ավելի շատ միավոր, բ) ավելի լավ գոլային տարբերություն, գ) ավելի շատ գոլ։ <i>(ՖԻՖԱ 2026-ի կանոն)</i></li>
        <li>Եթե դա էլ է հավասար → <b>ընդհանուր գոլային տարբերությունը</b> (բոլոր խաղերում՝ խփած հանած բաց թողած)։</li>
        <li>Եթե դեռ հավասար են → ով <b>ընդհանուր ավելի շատ գոլ</b> է խփել։</li>
      </ol>
      <p class="muted" style="margin-top:6px;">💡 Պարզ ասած՝ եթե 2 թիմ հավասար միավոր ունեն, առաջինը կարևորը՝ ո՞վ ում հաղթեց իրար միջև, հետո նոր՝ ընդհանուր գոլերը։</p>
    ...
    <div class="glass-card" style="border:2px solid #FFD700;">
      ...
      <ul style="color:#FFFFFF; font-size:1.05rem;">
        ...
        <li>Առանձին խաղի միավորները ստանում ես ցանկացած դեպքում։ Խմբի բոնուսը հաշվարկվում է <b>քո կանխատեսած հաշիվներով</b>. բաց թողած խաղերը հաշվվում են որպես <b>0-0</b> (պարտադիր չէ կանխատեսել բոլոր 6 խաղերը)։</li>
...
# ===================  PAGE: MY RESULTS  ======================================
    ...
    if not bygroup:
        ...
        for i, g in enumerate(sorted(bygroup)):
            ...
            done_pairs = [(mm, p) for mm, p in zip(gms, preds) if p]
            done = len(done_pairs)
            total = len(gms)
            with gcols[i % 3]:
                if done_pairs:
                    ...
                    st.markdown(
                        ...
                        f"<small class='muted'>Կանխատեսիր այս խմբի խաղերը ({done}/{total})՝ "
