...
if page == "ԿԱՆՈՆՆԵՐ":
    ...
    <div class="glass-card">
      ...
      <p style="color:#FFFFFF;">Քո <b>կանխատեսած</b> խմբային աղյուսակը (անձնական էջում) հաշվարկվում է ՖԻՖԱ-ի պաշտոնական կարգով․</p>
      <ol style="color:#FFFFFF; font-size:1.05rem;">
        ...
        <li><b>Անձնական հանդիպումներ</b> (հավասար թիմերի միջև խաղի արդյունքը՝ միավոր → գոլային տարբերություն → խփած գոլ)</li>
      </ol>
      <div style="background:rgba(0,255,136,0.08); border:1px solid rgba(0,255,136,0.35); border-radius:12px; padding:12px; margin-top:12px;">
        <b style="color:#00ff88;">🏁 Ո՞վ է անցնում խմբից հաջորդ փուլ (1/16)</b>
        <ul style="color:#FFFFFF; margin-top:6px;">
          <li>Յուրաքանչյուր խմբի <b>1-ին և 2-րդ</b> տեղերը → <b>24 թիմ</b></li>
          <li>+ <b>8 լավագույն 3-րդ տեղ</b> զբաղեցրած թիմերը (բոլոր 12 խմբերից, դասավորված միավոր → գոլային տարբերություն → խփած գոլ)</li>
          <li>= ընդամենը <b>32 թիմ</b> անցնում է 1/16 փուլ։</li>
        </ul>
        <p class="muted" style="margin:6px 0 0 0;">Հենց այս 32 թիմի համար է «<b>Որակավորում +1</b>» բոնուսը՝ յուրաքանչյուր ճիշտ կանխատեսված անցնող թիմի համար։</p>
      </div>
      <p class="muted" style="margin-top:10px;">Իրական խմբային արդյունքը (հաղթող/2-րդ/անցնող թիմեր) մուտքագրում է <b>ադմինը՝ ձեռքով</b>, ապա համեմատվում է քո կանխատեսած աղյուսակի հետ։</p>
    </div>
