...
if page == "ԿԱՆՈՆՆԵՐ":
    ...
    <div class="glass-card">
      ...
      <p style="color:#FFFFFF;">Ջոկերը <b>կրկնապատկում</b> է տվյալ խաղի միավորները։ Ունես 3 ջոկեր՝ խիստ ֆիքսված փուլերով․</p>
      <ul style="color:#FFFFFF;">
        <li>🃏 1 — միայն <b>Խմբային փուլում</b></li>
        <li>🃏 2 — միայն <b>1/16 փուլում</b></li>
        <li>🃏 3 — միայն <b>1/8 փուլում</b></li>
      </ul>
      <p class="muted">Եթե փուլում ջոկերը չես օգտագործում՝ այն կորչում է (չի փոխանցվում)։</p>
    </div>

    <div class="glass-card">
      <h3>🧠 Բոնուս միավորներ</h3>
      <ul style="color:#FFFFFF; font-size:1.05rem;">
        <li><b>Խմբի աղյուսակ՝</b> ճիշտ <b>հաղթող +6</b>, ճիշտ <b>2-րդ տեղ +4</b> (յուրաքանչյուր խմբի համար)։</li>
        <li><b>Որակավորում՝ +1</b> միավոր յուրաքանչյուր թիմի համար, որը ճիշտ ես կանխատեսել, որ կանցնի 1/16 (առավելագույնը +32)։</li>
        <li><b>🥇 Մեդալներ</b> (ընտրվում են մինչև առաջին խաղը)՝ Ոսկի <b>+30</b>, Արծաթ <b>+18</b>, Բրոնզ <b>+12</b>։</li>
      </ul>
    </div>

    <div class="glass-card">
      <h3>📊 Ինչպե՞ս են որոշվում խմբային տեղերը (ՖԻՖԱ-ի կանոն)</h3>
      <p style="color:#FFFFFF;">Խմբի դասավորությունը՝ և՛ քո <b>կանխատեսածը</b> (անձնական էջում), և՛ <b>իրականը</b>, հաշվարկվում է ՖԻՖԱ-ի պաշտոնական կարգով․</p>
      <ol style="color:#FFFFFF; font-size:1.05rem;">
        <li><b>Միավորներ</b> (հաղթանակ՝ 3, ոչ-ոքի՝ 1, պարտություն՝ 0)</li>
        <li><b>Գոլային տարբերություն</b></li>
        <li><b>Խփած գոլերի քանակ</b></li>
      </ol>
      <p class="muted">Այս կարգով են որոշվում խմբի <b>1-ին (հաղթող)</b>, <b>2-րդ</b> և <b>3-րդ</b> տեղերը։ Անձնական էջում կտեսնես քո կանխատեսած աղյուսակները՝ թարմացված ինքնաշխատ։</p>
    </div>
    ...
    <div class="glass-card" style="border:2px solid #FFD700;">
      ...
      <ul style="color:#FFFFFF; font-size:1.05rem;">
        ...
        <li>Փակման ժամը լրանալուց հետո խաղը <b>փակվում է</b>, և կանխատեսումն այլևս հնարավոր չէ։</li>
...
# ===================  PAGE: PREDICTIONS  =====================================
    ...
    def render_card(m):
        ...
        with c3: st.markdown(f"<div class='team-box'>{m['away_team']}</div>", unsafe_allow_html=True)
        if existing:                       # immutable — already predicted
            ...
            with c2:
                h = st.number_input("Տանտեր", min_value=0, step=1, key=f"h_{m['id']}")
                a = st.number_input("Հյուր", min_value=0, step=1, key=f"a_{m['id']}")
